...
import 'stick_underself_model.dart';
export 'stick_underself_model.dart';

class StickUnderselfWidget extends StatefulWidget {
  const StickUnderselfWidget({Key? key}) : super(key: key);

  @override
  _StickUnderselfWidgetState createState() => _StickUnderselfWidgetState();
}

class _StickUnderselfWidgetState extends State<StickUnderselfWidget>
    with TickerProviderStateMixin {
  late StickUnderselfModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StickUnderselfModel());
  }
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL(
                          'https://youtu.be/99EJRAZF3jk?si=_JMiDFih0rxVzA82');
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      height: 190.0,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'jrvcvvvo' /* Расставь шайбы в линию, и начн... */,
                      ),
                      textAlign: TextAlign.start,
                ...
                if (FFAppState().stickUnderselfProgress < 1.0)
                  Padding(
                    padding:
