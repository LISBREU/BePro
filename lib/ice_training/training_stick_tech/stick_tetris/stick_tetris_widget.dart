...
import 'stick_tetris_model.dart';
export 'stick_tetris_model.dart';

class StickTetrisWidget extends StatefulWidget {
  const StickTetrisWidget({Key? key}) : super(key: key);

  @override
  _StickTetrisWidgetState createState() => _StickTetrisWidgetState();
}

class _StickTetrisWidgetState extends State<StickTetrisWidget>
    with TickerProviderStateMixin {
  late StickTetrisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StickTetrisModel());
  }
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL(
                          'https://youtu.be/cCN31FQ2py0?si=ZQMlj-n9gQtUsT3n');
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      height: 190.0,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'o25hxfzk' /* Возьми одну шайбу и выставь ли... */,
                      ),
                      textAlign: TextAlign.start,
                ...
                if (FFAppState().stickTetrisProgress < 1.0)
                  Padding(
                    padding:
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: LinearPercentIndicator(
                                          percent:
                                              FFAppState().stickTetrisProgress,
                                          width: 195.0,
                                          lineHeight: 24.0,
                                          animation: true,
