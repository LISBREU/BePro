...
import 'stick_backhand_model.dart';
export 'stick_backhand_model.dart';

class StickBackhandWidget extends StatefulWidget {
  const StickBackhandWidget({Key? key}) : super(key: key);

  @override
  _StickBackhandWidgetState createState() => _StickBackhandWidgetState();
}

class _StickBackhandWidgetState extends State<StickBackhandWidget>
    with TickerProviderStateMixin {
  late StickBackhandModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StickBackhandModel());
  }
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      await launchURL('https://youtu.be/fgzrD2WblhU');
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      height: 190.0,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'q0crx4t0' /* Расположи препятствия в выбран... */,
                      ),
                      textAlign: TextAlign.start,
                ...
                if (FFAppState().stickBackhandProgress < 0.9)
                  Padding(
                    padding:
