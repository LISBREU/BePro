...
import 'stick_forehand_model.dart';
export 'stick_forehand_model.dart';

class StickForehandWidget extends StatefulWidget {
  const StickForehandWidget({Key? key}) : super(key: key);

  @override
  _StickForehandWidgetState createState() => _StickForehandWidgetState();
}

class _StickForehandWidgetState extends State<StickForehandWidget>
    with TickerProviderStateMixin {
  late StickForehandModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StickForehandModel());
  }
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      await launchURL('https://youtu.be/tpcVGhvx3LE');
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      height: 190.0,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        '6pkzlkbj' /* Расположи препятствия в выбран... */,
                      ),
                      textAlign: TextAlign.start,
                ...
                if (FFAppState().stickForehandProgress < 0.9)
                  Padding(
                    padding:
