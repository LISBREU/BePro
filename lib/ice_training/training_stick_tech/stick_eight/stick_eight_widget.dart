...
import 'stick_eight_model.dart';
export 'stick_eight_model.dart';

class StickEightWidget extends StatefulWidget {
  const StickEightWidget({Key? key}) : super(key: key);

  @override
  _StickEightWidgetState createState() => _StickEightWidgetState();
}

class _StickEightWidgetState extends State<StickEightWidget>
    with TickerProviderStateMixin {
  late StickEightModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StickEightModel());
  }
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL(
                          'https://youtu.be/uaYdhY5AreY?si=D3eL_p-XTpMALnnc');
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      height: 190.0,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        '1q3e3jiv' /* Расставь две шайбы перед собой... */,
                      ),
                      textAlign: TextAlign.start,
                ...
                if (FFAppState().stickEightProgress < 1.0)
                  Padding(
                    padding:
