...
class MoshnostZhimWidget extends StatefulWidget {
  const MoshnostZhimWidget({Key? key}) : super(key: key);

  @override
  _MoshnostZhimWidgetState createState() => _MoshnostZhimWidgetState();
}
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL(
                          'https://youtu.be/euDdZC7c9PM?si=UOxL7TlCQWtH-tjL');
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      height: 190.0,
